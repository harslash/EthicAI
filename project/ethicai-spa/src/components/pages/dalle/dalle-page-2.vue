<template>
    ...
    <div class="container-fluid page-container text-center">
        <div class="section-one container mb-5 text-section" :class="{ 'hidden': !showFirstSection }">
            ...
            <div class="row h-30">
                <div class="col-md-4 d-flex align-items-center">
                    <figure>
                        <img class="img-a" src="../../../assets//Robot_Head_by_DALL-E_2.jpg"
                            alt="Escher Robot Head by DALL-E 2"
                            style="display: inline-block;  margin: 25px 10px; border-radius: 5px;" />
                ...
                <div class="col-md-8 d-flex align-items-center">
                    <div class="d-flex justify-content-center flex-wrap">
                        <p class="text-left section-text">
                            There is no agreed-upon definition of art. It may be subjective. Experts disagree. What we call
                            AI art, differs from human-made art because it is driven by commands and instructions, rather
                            than an expression of genuine emotion.
                        </p>

                        <p class="text-left section-text">
                            AI generators merge visual features from pre-existing images to assemble a requested concept.
                            Some claim 'true' art must be unique; others argue that even human-made art might just be a
                            recombination based on existing styles — which in some ways is similar to generative AI

                            <span class="reference-link" @click="handleReferenceClick('generatedVsHuman')">(Nanou,
                                2022)</span>.
                        </p>

                        <p class="text-left section-text">
                            As different generative AI models are trained on larger datasets and approach those styles more
                            faithfully, it becomes increasingly challenging to distinguish between AI generated art and
                            human art — especially if AI generators draw influences from pre-existing images.
                        </p>
        ...
        <div ref="secondSection" class="section-two container mb-5 text-section" :class="{ 'hidden': !showSecondSection }">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div class="card" :class="firstQuestionShowCorrect ? 'purp' : 'non-purp-grey'"
                                        @click="onFirstCorrectClick(); showSecondQuestion = true; scrollIntoSecondQuestion()"
                                        role="link">
                                        <div class="card-body">
                                    ...
                                    <div class="correct" :class="{ 'hidden': !firstQuestionShowCorrect }">
                                        <p style="display: block;"> <span style="color: #6D0CFF"> Correct! +1 point </span>
                                            <br> You successfully identified the work of a human.
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="card" :class="firstQuestionShowIncorrect ? 'grey' : 'non-purp-grey'"
                                        @click="onFirstIncorrectClick(); showSecondQuestion = true;" role="link">
                                        <div class="card-body">
                                    ...
                                    <div class="incorrect" :class="{ 'hidden': !firstQuestionShowIncorrect }">
                                        <p style="display: block;"> <span style="color: #707070;"> Oops, you have
                                                misidentified this as human made! </span> <br> {{ teachableMsg1 }} </p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <!-- Second question -->
            <div ref="secondQuestion" class="question-two container mb-5 text-section"
                :class="{ 'hidden': !showSecondQuestion }">
                <div class="col-md-12 d-flex align-self-center justify-content-center">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="card" :class="secondQuestionShowCorrect ? 'purp' : 'non-purp-grey'"
                                    @click="onSecondCorrectClick(); showThirdQuestion = true; scrollIntoThirdQuestion()"
                                    role="link">
                                    <div class="card-body">
                                ...
                                <div class="correct" :class="{ 'hidden': !secondQuestionShowCorrect }">
                                    <p style="display: block;"> <span style="color: #6D0CFF"> Correct! +1 point </span> <br>
                                        You successfully identified the work of a human.</p>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="card" :class="secondQuestionShowIncorrect ? 'grey' : 'non-purp-grey'"
                                    @click="onSecondIncorrectClick(); showThirdQuestion = true;" role="link">
                                    <div class="card-body">
                                ...
                                <div class="incorrect" :class="{ 'hidden': !secondQuestionShowIncorrect }">
                                    <p style="display: block;"> <span style="color: #707070;"> Oops, you have misidentified
                                            this as human made! </span> <br> {{ teachableMsg2 }} </p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Third question -->
            <div ref="thirdQuestion" class="question-three container mb-5 text-section"
                :class="{ 'hidden': !showThirdQuestion }">
                <div class="col-md-12 d-flex align-self-center justify-content-center">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="card" :class="thirdQuestionShowIncorrect ? 'grey' : 'non-purp-grey'"
                                    @click="onThirdIncorrectClick(); showFourthQuestion = true;" role="link">
                                    <div class="card-body">
                                ...
                                <div class="incorrect" :class="{ 'hidden': !thirdQuestionShowIncorrect }">
                                    <p style="display: block;"> <span style="color: #707070;"> Oops, you have misidentified
                                            this as human made! </span> <br> {{ teachableMsg3 }} </p>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="card" :class="thirdQuestionShowCorrect ? 'purp' : 'non-purp-grey'"
                                    @click="onThirdCorrectClick(); showFourthQuestion = true; scrollIntoFourthQuestion()"
                                    role="link">
                                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="card" :class="fourthQuestionShowIncorrect ? 'grey' : 'non-purp-grey'"
                                    @click="onFourthIncorrectClick(); showFifthQuestion = true;" role="link">
                                    <div class="card-body">
                                ...
                                <div class="incorrect" :class="{ 'hidden': !fourthQuestionShowIncorrect }">
                                    <p style="display: block;"> <span style="color: #707070;"> Oops, you have misidentified
                                            this as human made! </span> <br> {{ teachableMsg4 }} </p>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="card" :class="fourthQuestionShowCorrect ? 'purp' : 'non-purp-grey'"
                                    @click="onFourthCorrectClick(); showFifthQuestion = true; scrollIntoFifthQuestion()"
                                    role="link">
                                    <div class="card-body">
            ...
            <div class="row h-30">
                ...
                <div ref="fifthQuestion" class="question-five container mb-5 text-section"
                    ...
                    <div class="col-md-12 d-flex align-self-center justify-content-center">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div class="card" :class="fifthQuestionShowCorrect ? 'purp' : 'non-purp-grey'"
                                        @click="onFifthCorrectClick(); showContinue = true; scrollIntoContinue()"
                                        role="link">
                                        <div class="card-body">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="card" :class="fifthQuestionShowIncorrect ? 'grey' : 'non-purp-grey'"
                                        @click="onFifthIncorrectClick(); showContinue = true; scrollIntoContinue()"
                                        role="link">
                                        <div class="card-body">
                                    ...
                                    <div class="incorrect" :class="{ 'hidden': !fifthQuestionShowIncorrect }">
                                        <p style="display: block;"> <span style="color: #707070;"> Oops, you have
                                                misidentified this as human made! </span> <br> {{ teachableMsg5 }} </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div v-if="scoreVisible" class="row h-10">
                        <div class="col-md-12 score-container">
                            <span class="purple-text">
                                <p><em><u>You scored: {{ score }} / 5 correctly! Great work</u></em></p>
                            </span>
                        </div>
                ...
                <div class="row h-20">
                    <div class="col-md-12 d-flex justify-content-center">
                        <purple-btn v-if="quizCompleted && !section2Completed && !redoQuiz" :text="'Retry'"
                ...
                <div class="row h-20">
                    <div class="col-md-12 d-flex justify-content-end">
                        <purple-btn v-if="quizCompleted && !section2Completed" :text="'Continue'"
                            @click="showThirdSection = true; scrollIntoThirdSection(); section2Completed = true;" />
                    </div>
                </div>

                <div ref="thirdSection" class="row h-30 mb-8 justify-content-center"
                    ...
                    <div class="article-snippet text-center align-items-center mx-auto">
                        ...
                        <p class="article-excerpt">
                            AI art generators are sometimes so powerful that it is hard to tell AI-generated images from
                            actual pictures. There are some clues you can look for to identify these and potentially avoid
                    ...
                    <div class="col-md-8 text-center">
                        <br>
                        <p> Some of these are quite tricky to decide, even for the savviest of quiz-takers. It just goes to
                            show how important it is to pay attention to details. </p>
                    </div>
