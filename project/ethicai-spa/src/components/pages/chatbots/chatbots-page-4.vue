      ...
      <div class="col-md-8 d-flex align-items-center">
        <div class="d-flex justify-content-center flex-wrap">
          ...
          <p class="section-text">
            ...
            Educational institutions have begun to use tools like ZeroGPT to detect plagiarism and content generated by LLMs. These tools can detect AI-generated text with an accuracy rate of up to 98%, making it easy for educators to identify students who cheat (<router-link :to="{ name: 'references' }">ZeroGPT, 2023</router-link>). If you start to rely on ChatGPT to finish your assignments instead of learning to complete them yourself, it’s only a matter of time before you get caught. Using AI tools violates academic integrity and could result in harsh penalties. Is it really worth it?
          </p>
        </div>
      </div>
      ...
      <div class="row pb-5"> 
        <div class="col-md-12 d-flex justify-content-center align-items-center flex-wrap"> <!-- Center content vertically and horizontally -->
          ...
          <p class="section-text purple-text">
            Guideline 1: Effective prompting (<router-link :to="{ name: 'references' }">NSW Education, 2023</router-link>).
          </p>
          <p class="section-text">
    ...
    <div 
        ...
        <div class="row">
          <div class="col-md-12 pb-5 d-flex justify-content-center flex-wrap"> 
              <p class="section-text purple-text">Guideline 2: Review and verify (<router-link :to="{ name: 'references' }">Alston, 2023</router-link>)</p>
      ...
      <div 
          ...
          <div class="row">
            <div class="col-md-12 pb-5 d-flex justify-content-center flex-wrap"> 
                <p class="section-text purple-text">Guideline 3: Keep your information private (<router-link :to="{ name: 'references' }">Cousins, 2023</router-link>)</p>
